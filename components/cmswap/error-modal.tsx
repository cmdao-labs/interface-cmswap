                ...
                <DialogHeader className="flex flex-row items-center gap-2 text-left">
                    ...
                    <div>
                        ...
                        <div className="flex items-center gap-2 mt-1">
                            <Badge variant="outline" className="text-xs font-normal bg-red-50 dark:bg-red-900/10 text-red-600 dark:text-red-400 border-red-200 dark:border-red-800">v{process.env.APP_VERSION}</Badge>
