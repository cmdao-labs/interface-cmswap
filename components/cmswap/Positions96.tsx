...
const { tokens, POSITION_MANAGER, v3FactoryContract, positionManagerContract, erc20ABI, kap20ABI, v3PoolABI, wrappedNative, } = chains[96]
...
export default function Positions96({ setIsLoading, setErrMsg, }: {
