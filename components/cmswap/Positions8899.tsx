...
const { tokens, POSITION_MANAGER, v3FactoryContract, positionManagerContract, erc20ABI, v3PoolABI, wrappedNative, } = chains[8899]
...
export default function Positions8899({ setIsLoading, setErrMsg, }: {
