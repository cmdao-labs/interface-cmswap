...
export default function Fields({ callMode, navigate }: {callMode: (_mode: number) => void, navigate: NavigateFunction}) {
    ...
    return (
        <>
            ...
            <div className="w-full mt-6 px-10 text-lg text-left">Non-committed point-to-token hook</div>
            <div className="w-full mt-6 px-10 flex flex-row items-start justify-start">
