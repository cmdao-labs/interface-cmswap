...
export default async function LeaderboardPage(props: {
    ...
    return (
        <main className="row-start-2 md:w-6/7 w-full self-center h-full flex flex-col gap-6 items-center sm:items-start mt-16">
            <Link href={"/pump/launchpad?chain=" + chain + (mode === 'pro' ? "&mode=pro" : "&mode=lite")} prefetch={false} className="w-full text-sm underline hover:font-bold px-4">Back to launchpad</Link>
