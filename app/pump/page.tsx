...
export default function Home() {
  ...
  useEffect(() => {
    ...
    if (chainId === 25925 || chainId === null) {
      ...
      // แสดง popup แจ้งเตือนก่อน redirect
      setShowPopup(true);
    }
  }, [chainId]);
  ...
  const handleConfirm = () => {
    if (chainId === 96)
      window.location.href = 'https://www.cmswap.fun/pump/launchpad?chain=kub&mode=pro';
    else if (chainId === 10143)
      window.location.href = 'https://www.cmswap.fun/pump/launchpad?chain=monad&mode=pro';
  };
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm">
          <div className="bg-[#0c1917] border border-green-400/30 rounded-2xl p-6 text-center shadow-2xl w-[90%] max-w-md">
            ...
            <p className="text-gray-300 text-sm leading-relaxed">
              ...
              {chainId === 96 ? ' KUB Chain (Mainnet)' : ' Monad Testnet'}.<br />
            ...
            <div className="flex justify-center gap-4 mt-6">
              <button
                ...
                className="px-4 py-2 rounded-lg bg-gray-800 text-gray-200 hover:bg-gray-700 border border-gray-600 transition"
              >
                No, stay on Pump v2 (KUB Testnet)
              </button>
              <button
