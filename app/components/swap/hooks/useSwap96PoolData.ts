        ...
        const fetchPoolData = async () => {
            ...
            if (stateA[0].result && tokenA.name === 'Choose Token') {
                ...
                setTokenA({
                    ...
                    value: tokenA.value,
                    logo: existing?.logo ?? '../favicon.ico',
                })
            }
            ...
            const updateExchangeRateCMswapTVL = (feeAmount: number, exchangeRate: number) => {
                setCMswapTVL(prev => ({
                    ...
                    FixedExchangeRate: feeSelect === feeAmount ? exchangeRate.toString() : prev.FixedExchangeRate,
                }))
            }
            ...
            if (tokenA.name !== 'Choose Token' && tokenB.name !== 'Choose Token') {
                if (
                    ...
                    try {
                        ...
                        const computePrice = (token0: string, sqrtPriceX96: bigint) =>
                        ...
                        let currPrice_10000 =
                            token0_10000.toUpperCase() === tokenBvalue.toUpperCase()
                                ? (Number(sqrtPriceX96_10000) / (2 ** 96)) ** 2
                                : 1 / ((Number(sqrtPriceX96_10000) / (2 ** 96)) ** 2)

                        if (
                            (tokenAvalue === ('0x67eBD850304c70d983B2d1b93ea79c7CD6c3F6b5' as '0xstring') &&
                                tokenBvalue === ('0x7d984C24d2499D840eB3b7016077164e15E5faA6' as '0xstring')) ||
                            (tokenAvalue === ('0x7d984C24d2499D840eB3b7016077164e15E5faA6' as '0xstring') &&
                                tokenBvalue === ('0x67eBD850304c70d983B2d1b93ea79c7CD6c3F6b5' as '0xstring'))
                        ) {
                            if (feeSelect === 10000) {
                        ...
                        const tvl_10000 =
                            currPrice_10000 !== 0 && currPrice_10000 !== Infinity
                                ? Number(formatEther(tokenAamount_10000)) * (1 / currPrice_10000) +
                                  Number(formatEther(tokenBamount_10000))
                                : 0
                        ...
                        if (feeSelect === 10000 && tvl_10000 < 1e-9) {
                            ...
                            for (let i = 0; i <= tokens.length - 1; i++) {
                                init.contracts.push({
                                    ...
                                    args: [tokenAvalue, tokens[i].value, 10000],
                                })
                                init.contracts.push({
                                    ...v3FactoryContract,
                                    functionName: 'getPool',
                                    args: [tokens[i].value, tokenBvalue, 10000],
                                })
                            }
                            ...
                            for (let i = 0; i <= findAltRoute.length - 1; i += 2) {
                                if (
                                    findAltRoute[i].result !== '0x0000000000000000000000000000000000000000' &&
                            ...
                            if (altIntermediate !== undefined) {
                                ...
                                const alt0sqrtPriceX96 =
                                    altPoolState[1].result !== undefined ? altPoolState[1].result[0] : BigInt(0)
                                const altPrice0 =
                                    altToken0.toUpperCase() === tokenAvalue.toUpperCase()
                                        ? (Number(alt0sqrtPriceX96) / (2 ** 96)) ** 2
                                        : 1 / ((Number(alt0sqrtPriceX96) / (2 ** 96)) ** 2)
                                const altToken1 = (altPoolState[2].result ?? '') as string
                                const alt1sqrtPriceX96 =
                                    altPoolState[3].result !== undefined ? altPoolState[3].result[0] : BigInt(0)
                                const altPrice1 =
                                    altToken1.toUpperCase() === tokenBvalue.toUpperCase()
                        ...
                        const tvl_3000 =
                            currPrice_3000 !== 0 && currPrice_3000 !== Infinity
                                ? Number(formatEther(tokenAamount_3000)) * (1 / currPrice_3000) +
                                  Number(formatEther(tokenBamount_3000))
                                : 0
                        if (feeSelect === 3000) {
                        ...
                        if (feeSelect === 3000 && tvl_3000 < 1e-9) {
                            ...
                            for (let i = 0; i <= tokens.length - 1; i++) {
                                init.contracts.push({
                                    ...v3FactoryContract,
                                    functionName: 'getPool',
                                    args: [tokenAvalue, tokens[i].value, 3000],
                                })
                                init.contracts.push({
                                    ...v3FactoryContract,
                                    functionName: 'getPool',
                                    args: [tokens[i].value, tokenBvalue, 3000],
                                })
                            }
                            const findAltRoute = await readContracts(config, init)
                            let altIntermediate: Token | undefined
                        ...
                        const tvl_500 =
                            currPrice_500 !== 0 && currPrice_500 !== Infinity
                                ? Number(formatEther(tokenAamount_500)) * (1 / currPrice_500) +
                                  Number(formatEther(tokenBamount_500))
                                : 0
                        if (feeSelect === 500) {
                        ...
                        if (feeSelect === 500 && tvl_500 < 1e-9) {
                            ...
                            for (let i = 0; i <= tokens.length - 1; i++) {
                                init.contracts.push({
                                    ...v3FactoryContract,
                                    functionName: 'getPool',
                                    args: [tokenAvalue, tokens[i].value, 500],
                                })
                                init.contracts.push({
                                    ...v3FactoryContract,
                                    functionName: 'getPool',
                                    args: [tokens[i].value, tokenBvalue, 500],
                                })
                            }
                            const findAltRoute = await readContracts(config, init)
                            let altIntermediate: Token | undefined
                        ...
                        const tvl_100 =
                            currPrice_100 !== 0 && currPrice_100 !== Infinity
                                ? Number(formatEther(tokenAamount_100)) * (1 / currPrice_100) +
                                  Number(formatEther(tokenBamount_100))
                                : 0
                        if (feeSelect === 100) {
                        ...
                        if (feeSelect === 100 && tvl_100 < 1e-9) {
                            ...
                            for (let i = 0; i <= tokens.length - 1; i++) {
                                init.contracts.push({
                                    ...v3FactoryContract,
                                    functionName: 'getPool',
                                    args: [tokenAvalue, tokens[i].value, 100],
                                })
                                init.contracts.push({
                                    ...v3FactoryContract,
                                    functionName: 'getPool',
                                    args: [tokens[i].value, tokenBvalue, 100],
                                })
                            }
                            const findAltRoute = await readContracts(config, init)
                            let altIntermediate: Token | undefined
                    ...
                    try {
                            ...
                            contracts: [
                                {
                                    ...
                                    args: [BigInt(0), tokenAvalue, tokenBvalue],
                                },
                            ],
                        })
                        const DiamonPair =
                            getPairAddr[0].result !== undefined ? (getPairAddr[0].result as '0xstring') : ('' as '0xstring')
                        ...
                        if (DiamonPair !== ('0x0000000000000000000000000000000000000000' as '0xstring')) {
                            ...
                            const currPriceDM =
                                getPoolState[2].result !== undefined ? Number(tokenAamount) / Number(tokenBamount) : 0

                            tvlDM =
                                currPriceDM !== 0 && currPriceDM !== Infinity
                                    ? Number(formatEther(tokenAamount)) * (1 / currPriceDM) +
                                      Number(formatEther(tokenBamount))
                                    : 0
                            exchangeRateDM = tvlDM < 1e-9 ? 0 : currPriceDM
                            if (currPriceDM !== Infinity) {
                                setDMswapTVL(prev => ({
                                    ...prev,
                                    FixedExchangeRate: exchangeRateDM.toString(),
                                }))
                            }
                        } else {
                            tvlDM = 0
                    ...
                    try {
                            ...
                            contracts: [
                                {
                                    ...CMswapUniSmartRouteContractV2,
                                    functionName: 'getPairAddress',
                                    args: [BigInt(1), tokenAvalue, tokenBvalue],
                                },
                            ],
                        })
                        const UdonPair =
                        ...
                        if (UdonPair !== ('0x0000000000000000000000000000000000000000' as '0xstring')) {
                            ...
                            tvlUdon =
                                (Number(formatEther(tokenAamount)) * (1 / currPriceUdon)) +
                                Number(formatEther(tokenBamount))
                            exchangeRateUdon = tvlUdon < 1e-9 ? 0 : currPriceUdon
                            if (currPriceUdon !== Infinity) {
                                setUdonTVL(prev => ({
                                    ...prev,
                                    FixedExchangeRate: Number(exchangeRateUdon).toString(),
                                }))
                            }
                        }
                    ...
                    try {
                            ...
                            contracts: [
                                {
                                    ...CMswapUniSmartRouteContractV2,
                                    functionName: 'getPairAddress',
                                    args: [BigInt(2), tokenAvalue, tokenBvalue],
                                },
                            ],
                        })
                        const DiamonPair =
                        ...
                        if (DiamonPair !== ('0x0000000000000000000000000000000000000000' as '0xstring')) {
                            ...
                            if (currPriceDM !== Infinity) {
                                setPonderTVL(prev => ({
                                    ...prev,
                                    FixedExchangeRate: Number(exchangeRatePD).toString(),
                                }))
                            }
                        }
