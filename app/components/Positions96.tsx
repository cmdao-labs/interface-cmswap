...
import { tokens, POSITION_MANAGER, v3FactoryContract, positionManagerContract, erc20ABI, kap20ABI, v3PoolABI, wrappedNative } from '@/app/lib/96'
...
export default function Positions96({ 
