...
import { 
  v3FactoryContract,
  erc20ABI,
  v3PoolABI as v3PoolABI_25925,
  V3_FACTORY as V3_FACTORY_25925,
  V3_FACTORYCreatedAt as V3_FACTORYCreatedAt_25925,
  positionManagerContract as positionManagerContract_25925,
} from '@/app/lib/25925'
...
export default function LiquidityPool96() {
  ...
  const fetchPools = async () => {
    ...
    const logCreateData = await publicClient.getContractEvents({
      ...
      fromBlock: V3_FACTORYCreatedAt_25925,
      toBlock: 'latest',
    });
