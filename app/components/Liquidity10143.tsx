        ...
        <div className='space-y-2'>
            ...
            <div className="mt-4 border-t border-[#00ff9d]/10 pt-4">
                <div className="flex items-center text-gray-500 text-xs my-2">
                    ...
                    <span className="text-[#00ff9d] text-xs px-2 gap-1">{Number(currPrice).toFixed(6)} {tokenA.value !== '0x' as '0xstring' && tokenB.value !== '0x' as '0xstring' && tokenA.name + '/' + tokenB.name}</span>
                </div>
            </div>
        </div>
    )
