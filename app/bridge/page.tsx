...
export default function BridgeInterface() {
    ...
    return (
        <div className="min-h-screen bg-[#0a0b1e] p-4 font-mono" style={{backgroundImage: `linear-gradient(to right, rgba(0,255,157,0.03) 1px, transparent 1px), linear-gradient(to bottom, rgba(0,255,157,0.03) 1px, transparent 1px)`, backgroundSize: "20px 20px"}}>
            {isLoading && <div className="w-full h-full fixed backdrop-blur-[12px] z-999" />}
            <ErrorModal errorMsg={errMsg} setErrMsg={setErrMsg} />
            <div className="max-w-md mx-auto">
                <div className="rounded-lg border border-[#00ff9d]/10 bg-[#0f1c2a]/90 backdrop-blur-sm p-4 mt-[100px]">
