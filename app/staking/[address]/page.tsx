                                        ...
                                        <>
                                            {position.map(obj => 
                                                <div key={Number(obj.Id)} className="mb-4 bg-[#0a0b1e]/80 border border-[#00ff9d]/10 rounded-xl gap-2 flex flex-col items-start text-xs">
                                                    <div className="w-full py-4 h-[80px] bg-white/5 rounded-t-xl relative inset-0 bg-[linear-gradient(to_right,#80808012_1px,transparent_1px),linear-gradient(to_bottom,#80808012_1px,transparent_1px)] bg-[size:24px_24px]">
